...
import infinitetides.phantomtactics.data.model.PlayerTurn;
import infinitetides.phantomtactics.util.GameUtils;

public class PhantomTacticsActivity extends Activity
    ...
    public void onActivityResult(int request, int response, Intent data) {
        ...
        if (request == RC_SIGN_IN) {
            ...
            if (response == Activity.RESULT_OK) {
                ...
                GameUtils.showActivityResultError(this, request, response, R.string.signin_other_error);
            }
